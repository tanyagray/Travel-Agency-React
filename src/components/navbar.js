  ...
  return (
    <nav data-role="Header" className={`navbar-navbar ${props.rootClassName} `}>
      <h1>
        {props.logo ?? (
          <Fragment>
            <span className="navbar-text27">Travel</span>
          </Fragment>
        )}
      </h1>
      <div className="navbar-right-side1">
        <div className="navbar-links-container1">
          ...
          <span className="navbar-text11">
            {props.text1 ?? (
              <Fragment>
                <span className="navbar-text29">About</span>
              </Fragment>
            )}
          </span>
          <span className="navbar-text12">
            {props.text2 ?? (
              <Fragment>
                <span className="navbar-text26">Tour Packages</span>
              </Fragment>
            )}
          </span>
          <span className="navbar-text13">
            {props.text3 ?? (
              <Fragment>
                <span className="navbar-text22">Contact</span>
              </Fragment>
            )}
          </span>
        </div>
      ...
      <div data-role="BurgerMenu" className="navbar-burger-menu1">
        ...
        <div className="navbar-nav">
          <div className="navbar-top">
            <h1>
              {props.logo1 ?? (
                <Fragment>
                  <span className="navbar-text21">Travel</span>
                </Fragment>
              )}
            </h1>
            <div data-role="CloseMobileMenu" className="navbar-close-menu">
              <svg viewBox="0 0 1024 1024" className="navbar-icon13">
                <path d="M810 274l-238 238 238 238-60 60-238-238-238 238-60-60 238-238-238-238 60-60 238 238 238-238z"></path>
              </svg>
            </div>
          </div>
          <div className="navbar-right-side2">
            <div className="navbar-links-container2">
              <span className="navbar-text14">
                {props.text5 ?? (
                  <Fragment>
                    <span className="navbar-text24">Home</span>
                  </Fragment>
                )}
              </span>
              <span className="navbar-text15">
                {props.text6 ?? (
                  <Fragment>
                    <span className="navbar-text25">About</span>
                  </Fragment>
                )}
              </span>
              <span className="navbar-text16">
                {props.text7 ?? (
                  <Fragment>
                    <span className="navbar-text20">Tour Packages</span>
                  </Fragment>
                )}
              </span>
              <span>
                {props.text8 ?? (
                  <Fragment>
                    <span className="navbar-text28">Contact</span>
                  </Fragment>
                )}
              </span>
            </div>
            <a href="#main-section" className="navbar-link2">
              <SolidButton button="Explore places"></SolidButton>
            </a>
          </div>
        </div>
...
Navbar.defaultProps = {
  ...
  iconUrl1: 'https://facebook.com',
  text2: undefined,
  logo: undefined,
  text8: undefined,
  text1: undefined,
  iconUrl2: 'https://twitter.com',
  rootClassName: '',
}
